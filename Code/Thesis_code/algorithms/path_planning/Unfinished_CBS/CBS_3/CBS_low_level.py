...
from Thesis_code.algorithms.path_planning.CBS_3 import CBS_MDD as MDD


def replan_agents(graph_representation, agent_states, constrained_agents, constraint_dictionary, max_step, heuristic, distance_map):
    ...
    for agent_id in constrained_agents:
        ...
        new_MDD = MDD.create_MDD(graph_representation, constraint_dictionary[agent_id], agent_states[agent_id], new_path[-2][1], distance_map)
        new_MDDs[agent_id] = new_MDD

    return True, new_paths, new_MDDs
